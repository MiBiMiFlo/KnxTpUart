...
void setup() {
  ...
  knx.setListenAddressCount(10);
  knx.addListenGroupAddress(KNX_GA(15,0,0));
  knx.addListenGroupAddress(KNX_GA(15,0,1));
  knx.addListenGroupAddress(KNX_GA(15,0,2));
  knx.addListenGroupAddress(KNX_GA(15,0,3));
  knx.addListenGroupAddress(KNX_GA(15,0,4));
  knx.addListenGroupAddress(KNX_GA(15,0,5));
  knx.addListenGroupAddress(KNX_GA(15,0,6));
  knx.addListenGroupAddress(KNX_GA(15,0,7));
  knx.addListenGroupAddress(KNX_GA(15,0,8));
  knx.addListenGroupAddress(KNX_GA(15,0,9));
}
